 ...
 * Дано одно натуральное число N(1<=N<=2e10^9) — количество людей на кофе-брейке.
 *
 ...
 * Чтобы разрезать рулет на 5 частей, Ване понадобится разделить его в соотношении 2:3, после чего совместить два рулета по левому
 * краю и разрезать больший рулет на одинарные кусочки — меньший тоже разделится на одинарные.
 */
fun main() {
